...
// // console.log(arr2);
// // console.log(arr2[2][1]); // Nested Arrays Indexs
...
// // console.log(arr10.indexOf("Azhar")); // prints index of azhar i.e 5
...
// // 2. it will concat in btwn all elements
// // 3. it will convert to a string


// // console.log(arr13.join("Azhar")); // prints anything given in ("string ") value
...
// let arr17 = ["Hello", "hi", "azhar"]; // keys are indexs
